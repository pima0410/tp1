	...
	<c:otherwise>
		...
		<c:forEach items="${ sessionScope.listClient}" var="listClient" varStatus="statut">
			...
			<tr class="${statut.count %2 == 0 ? 'pair' :'impair'}">
				...
				<td class="action"><a href="<c:url value="/suppressionClients" ><c:param name="idClient" value="${listClient.value['id'] }"></c:param></c:url>"><img alt="Supprimer" src="<c:url value="/inc/supprimer.png"/>"></a></td>
